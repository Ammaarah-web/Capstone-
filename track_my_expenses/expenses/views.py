...
from django.contrib.auth.decorators import login_required  # Ensure this is at the very top
...
@login_required  # ENFORCED: Do not remove. Protects against unauthenticated access.
